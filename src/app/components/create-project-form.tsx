      ...
      <div className="relative z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/80 dark:text-gray-300 mt-1">
                Add a new project to your dashboard instantly
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            <div className="group">
              <label className="block text-sm font-semibold mb-2 text-white dark:text-gray-200">
                Segment *
              </label>
              <select
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <motion.button
              ...
              type="button"
              onClick={handleClear}
              className="flex items-center justify-center gap-2 px-8 py-4 bg-white/20 dark:bg-gray-800/50 text-white rounded-xl hover:bg-white/30 dark:hover:bg-gray-700/50 transition-all shadow-lg backdrop-blur-md border border-white/30"
            >
              <X className="h-5 w-5" />
              Clear Form
            </motion.button>
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="submit"
              className="flex items-center justify-center gap-2 px-10 py-4 bg-white dark:bg-[#6366F1] text-[#4F6BED] dark:text-white rounded-xl hover:bg-white/90 dark:hover:bg-[#5558E3] transition-all shadow-2xl font-semibold"
            >
