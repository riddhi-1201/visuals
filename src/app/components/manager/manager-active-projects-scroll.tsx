...
import { ManagerProjectCard } from "./manager-project-card";
import type { ManagerProjectCardProps } from "./manager-project-card";

interface ManagerActiveProjectsScrollProps {
  projects: ManagerProjectCardProps[];
}

export function ManagerActiveProjectsScroll({ projects }: ManagerActiveProjectsScrollProps) {
